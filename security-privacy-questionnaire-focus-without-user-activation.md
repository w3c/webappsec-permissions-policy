...
This document answers the W3C **[Self-Review Questionnaire: Security and Privacy](https://www.w3.org/TR/security-privacy-questionnaire/)** for the **Permissions Policy: `focus-without-user-activation`** feature (see [explainer](policies/focus-without-user-activation.md) for more information).
...
This feature uses existing Permissions Policy syntax to control where programmatic focus is allowed. Embedders can apply it to first-party content, third-party embedded content, or both.
